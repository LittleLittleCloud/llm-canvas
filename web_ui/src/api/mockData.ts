...
export const helloCanvas: CanvasData = {
...
export const weatherCanvas: CanvasData = {
...
export const branchedCanvas: CanvasData = {
  ...
  nodes: {
    ...
    b3a: {
      ...
      parent_id: "b2",
      child_ids: ["b4a"],
      meta: { timestamp: Date.now() / 1000, branch: "japan" },
    },
    b4a: {
      id: "b4a",
      content: {
    ...
    b3b: {
      ...
      parent_id: "b2",
      child_ids: ["b4b"],
      meta: { timestamp: Date.now() / 1000, branch: "italy" },
    },
    b4b: {
      id: "b4b",
      content: {
...
export const branchedToolCanvas: CanvasData = {
  ...
  nodes: {
    ...
    bt3a: {
      ...
      parent_id: "bt2",
      child_ids: ["bt4a"],
      meta: { timestamp: Date.now() / 1000, branch: "stocks" },
    },
    bt4a: {
      id: "bt4a",
      content: {
    ...
    bt3b: {
      ...
      parent_id: "bt2",
      child_ids: ["bt4b"],
      meta: { timestamp: Date.now() / 1000, branch: "real_estate" },
    },
    bt4b: {
      id: "bt4b",
      content: {
